...
const
    //ghostscript32path = 'http://downloads.sourceforge.net/sourceforge/ghostscript/gs906w32.exe';
    //ghostscript64path = 'http://downloads.sourceforge.net/sourceforge/ghostscript/gs906w64.exe';
    //tiffURL = 'http://downloads.sourceforge.net/sourceforge/gnuwin32/tiff-3.8.2-1.exe';
    //mfilemonURL = 'http://downloads.sourceforge.net/project/mfilemon/1.4.2%20%282012-07-07%29/mfilemon-setup.exe';
    ...
    tiffURL = 'http://download.yajhfc.de/redirect/tiffsetup-newest.exe';
